...
nftban_cmd_port_help() {
    ...
    echo "                     brute-force rate-limit rule (tcp dport @ssh_ports"
    echo "                     ct count). INTERNAL/derived: managed automatically"
    ...
    echo "  (brute-force rate-limit), mirrored across IPv4 and IPv6. SFTP, SCP,"
