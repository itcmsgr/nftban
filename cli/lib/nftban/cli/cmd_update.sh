...
_cmd_update_main() {
    ...
    case "$_installer_state" in
        ...
        DEGRADED)
            ...
            echo ""
            echo "  Recommended:"
            echo "      sudo /usr/lib/nftban/bin/nftban-installer --repair   # re-run post-install validation"
        ...
        FAILED_*|FAILED)
            ...
            echo "      sudo /usr/lib/nftban/bin/nftban-installer --repair   # resume from failed phase"
