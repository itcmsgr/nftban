...
#     forward_chain_routing_host_f01_test.sh — v1.231 F-01 packet-outcome regression.
#                                   EVERY nft write is prefixed `ip netns exec <ns>`
#                                   and lands in a THROWAWAY NETWORK NAMESPACE created
#                                   and deleted by the test; the host ruleset is never
#                                   addressed, and the test asserts the host's netns
#                                   count and ip_forward are unchanged on exit. Routing
#                                   these through the daemon is not merely awkward but
#                                   IMPOSSIBLE — the daemon writes the host namespace,
#                                   which is the one namespace this test must not touch.
#                                   ROOT_LAB/lab-manual; NOT_EXECUTED without root/ip/nft.
...
#                                   table precedent.
ALLOWED_REGEX='^(cmd/nftband/|internal/nftbackend/|internal/setsync/|scripts/ci/|scripts/test_server_cleanup\.sh|cli/lib/nftban/tests/nft_writer_authority_v150_test\.sh|cli/lib/nftban/tests/blacklist_refresh_no_failopen_v192_test\.sh|cli/lib/nftban/tests/forward_chain_routing_host_f01_test\.sh|cli/lib/nftban/tests/rebuild_atomic_rollback_v1228_10_test\.sh|cli/lib/nftban/tests/ghost_table_foreign_preservation_v1228_11_test\.sh|cli/lib/nftban/tests/legacy_restore_neutralized_v1229_test\.sh|cli/sbin/nftban-apply|cli/sbin/nftban-rollback|cli/lib/nftban/lib/nft_ipc\.sh|cli/lib/nftban/core/nftban_health_fixes\.sh|cli/lib/nftban/cron/maintenance\.sh|cli/lib/nftban/helpers/autoheal\.sh|cli/lib/nftban/lib/nft_fragment\.sh|install/helpers/firewall-init-with-delay\.sh|cli/lib/nftban/cli/cmd_firewall\.sh|cli/lib/nftban/cli/cmd_flush\.sh|cli/lib/nftban/core/nftban_ddos_classic\.sh|cli/lib/nftban/core/nftban_firewall_conflicts\.sh|cli/lib/nftban/core/nftban_health_checks_security\.sh|cli/lib/nftban/cli/cmd_whitelist\.sh|cli/lib/nftban/cli/cmd_zabbix\.sh|cli/lib/nftban/cli/cmd_health_core\.sh|cli/lib/nftban/cli/cmd_firewall_logs\.sh|cli/lib/nftban/lib/service_control\.sh|cli/lib/nftban/core/nftban_system_ip\.sh)'
