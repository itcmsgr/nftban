...
ssh root@server2.example.com "nft delete table inet filter"

# Or disable from loading on boot:
ssh root@server2.example.com "systemctl disable nftables.service"
```
...
**server2.example.com (MOST ACTIVE!):**
- 2.57.121.112
- 45.135.232.92
- 45.135.232.177
- 45.140.17.124
