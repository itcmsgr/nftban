...
# =============================================================================
# NFTBan v0.32.21 - FHS Report Core Module
# =============================================================================
...
nftban_fhs_check_directory() {
    ...
    # Compare
    local issues=()
    [[ "$act_perms" != "$exp_perms" ]] && issues+=("perms")
...
"
    ...
    html_content="${html_content//\{NFTBAN_VERSION\}/${NFTBAN_VERSION:-0.32.1}}"
    html_content="${html_content//\{COMPANY_NAME\}/${NFTBAN_COMPANY_NAME:-}}"
    html_content="${html_content//\{LOGO_HTML\}/}"
    html_content="${html_content//\{VERSION_HTML\}/<p>Version: <strong>${NFTBAN_VERSION:-0.32.1}</strong></p>}"
