...
- **lab.example.test:** Package NOT installed via RPM (manual installation)
- **lab1.example.test:** Package NOT installed via DEB (manual installation)
...
|--------|-----|---------|---------------|--------------|--------|
| lab.example.test | CentOS Stream 9 | Manual v0.10 | 1/2 | ❌ No | Read-only FS, No email |
| lab1.example.test | Ubuntu 24.04 | Manual v0.10 | 1/2 | ❌ No | Read-only FS, No email |
| lab2.example.test | CentOS Stream 10 | Manual v0.10 | 1/2 | ❌ No | Read-only FS, No email |
| lab3.example.test | AlmaLinux 10.0 | Manual v0.10 | 0/2 | ❌ No | No mail cmd, No email |
| lab4.example.test | Rocky Linux 10 | RPM v0.10 | 1/2 | ❌ No | No mail cmd, No email |
...
- `docs/testing/v0.30/lab_logs/lab.example.test_status.log`
- `docs/testing/v0.30/lab_logs/lab1.example.test_status.log`
- `docs/testing/v0.30/lab_logs/lab2.example.test_status.log`
- `docs/testing/v0.30/lab_logs/lab3.example.test_status.log`
- `docs/testing/v0.30/lab_logs/lab4.example.test_status.log`
