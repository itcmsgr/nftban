...
# Example: ./scripts/test-go-feeds.sh lab.example.test ./go-feeds/nftban-feeds
...
if [[ $# -lt 2 ]]; then
    ...
    echo ""
    echo "Example:"
    echo "  $0 lab.example.test ./go-feeds/nftban-feeds"
    echo ""
    echo "Available lab servers:"
    echo "  lab.example.test   (Rocky Linux 9)"
    echo "  lab1.example.test  (Ubuntu 24.04)"
    echo "  lab2.example.test  (Rocky Linux 9)"
    echo "  lab3.example.test  (AlmaLinux 10)"
    echo "  lab4.example.test  (AlmaLinux 10)"
    exit 1
fi
