...
nftban_panel_directadmin_status() {
    ...
    if [[ -f "${NFTBAN_CONFIG_DIR}/conf.d/panels/directadmin/main.conf" ]]; then
        echo "  Config: ✓ ${NFTBAN_CONFIG_DIR}/conf.d/panels/directadmin/main.conf"
    else
...
nftban_panel_directadmin_report() {
    ...
    if [[ -f "${NFTBAN_CONFIG_DIR}/conf.d/panels/directadmin/main.conf" ]]; then
        # shellcheck source=/dev/null
        source "${NFTBAN_CONFIG_DIR}/conf.d/panels/directadmin/main.conf" || true
    fi
    ...
    echo "   ───────────────────────────────────────────────────"
    echo "   ${NFTBAN_CONFIG_DIR}/conf.d/panels/directadmin/main.conf"
