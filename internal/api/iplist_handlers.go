...
func (api *API) handleIPListBatch(w http.ResponseWriter, r *http.Request, set *setsync.Set, listName string) {
	...
	if err := setsync.ApplyStringDiffToSet(api.NFT, set, diff); err != nil {
...
func (api *API) handleIPListAdd(w http.ResponseWriter, r *http.Request, set *setsync.Set, listName string) {
	if r.Method != http.MethodPost {
		w.WriteHeader(http.StatusMethodNotAllowed)
		return
	}
...
func (api *API) handleIPListRemove(w http.ResponseWriter, r *http.Request, set *setsync.Set, listName string) {
	if r.Method != http.MethodPost {
		w.WriteHeader(http.StatusMethodNotAllowed)
		return
	}
...
func (api *API) handleIPListPreview(w http.ResponseWriter, r *http.Request, set *setsync.Set) {
	if r.Method != http.MethodPost {
		w.WriteHeader(http.StatusMethodNotAllowed)
		return
	}
