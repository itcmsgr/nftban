...
# Unquoted heredoc — all risk tokens explicitly escaped
PKG_VERSION=1.0.0
cat <<EOF
Backticks escaped: \`some-cmd\`
Command subst escaped: \$(date)
Arithmetic escaped: \$((1+1))
Vars unescaped (intentional emit-time): ${PKG_VERSION}
EOF
