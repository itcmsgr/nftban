...
# =============================================================================
# NFTBan v1.0.0 - Plesk Panel Library
# =============================================================================
#
# SPDX-License-Identifier: MPL-2.0
# Purpose: Plesk control panel firewall integration
#
# meta:name=nftban_panel_plesk
# meta:type=library
# meta:header=Plesk Panel Library
# meta:version=1.0.0
# meta:owner="Antonios Voulvoulis <contact@nftban.com>"
# meta:homepage=https://nftban.com
#
# **Description & Purpose**
# meta:description=Plesk panel integration with enable/disable/status/report/repair/test
...
nftban_panel_plesk_status() {
    ...
    # Configuration file
    echo "Configuration:"
    if [[ -f "/etc/nftban/conf.d/panels/plesk/main.conf" ]]; then
        echo "  Config: ✓ /etc/nftban/conf.d/panels/plesk/main.conf"
    else
...
nftban_panel_plesk_report() {
    ...
    if [[ -f "/etc/nftban/conf.d/panels/plesk/main.conf" ]]; then
        # shellcheck source=/dev/null
        source "/etc/nftban/conf.d/panels/plesk/main.conf"
