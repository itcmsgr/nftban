...
**lab2.example.test (CentOS Stream 10):**
```
table inet nftban_runtime   ✓
table inet nftban_main       ✓
```
...
- **lab:** 192.0.2.122 (common), 95.216.159.238
- **lab1:** 192.0.2.122 (common), 46.62.231.184
- **lab2:** 192.0.2.122 (common), 198.51.100.15

**Note:** 192.0.2.122 is common (probably management IP) ✓
...
ssh root@lab1.example.test "nft delete table inet filter"

# Or disable from loading on boot:
ssh root@lab1.example.test "systemctl disable nftables.service"
```
...
**lab2:**
- 198.51.100.15 (server's public IPv4)
- 2a01:4f9:c013:3f7a::1 (server's public IPv6)

**All share:** 192.0.2.122 (probably your management IP)
