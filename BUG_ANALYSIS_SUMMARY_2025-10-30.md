...
```bash
# Run on lab servers
ssh root@lab.mywebhost.gr "nftban module"
ssh root@lab.mywebhost.gr "nftban fhs"
ssh root@lab.mywebhost.gr "nftban port status"
ssh root@lab.mywebhost.gr "nftban stats dashboard"
```
