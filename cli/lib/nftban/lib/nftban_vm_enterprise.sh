...
# meta:name="nftban_vm_enterprise" meta:type="lib" meta:version="1.39.0" meta:owner="Antonios Voulvoulis <contact@nftban.com>" meta:description="Secure management of VictoriaMetrics Enterprise trial keys"
