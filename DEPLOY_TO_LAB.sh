...
echo ""
echo "Next steps:"
echo "  1. Test: ssh root@lab.mywebhost.gr 'nftban profile list'"
echo "  2. Test: ssh root@lab.mywebhost.gr 'nftban ddos status'"
echo "  3. Test: ssh root@lab.mywebhost.gr 'nftban portscan status'"
echo ""
