...
ssh root@lab.mywebhost.gr "nftban report generate"

# Test 2: Filename only (should work)
ssh root@lab.mywebhost.gr "nftban report generate --output test.html"

# Test 3: /tmp (should fail)
ssh root@lab.mywebhost.gr "nftban report generate --output /tmp/test.html"

# Test 4: /tmp with flag (should warn but work)
ssh root@lab.mywebhost.gr "nftban report generate --output /tmp/test.html --unsafe-allow-tmp"

# Test 5: /etc (should fail)
ssh root@lab.mywebhost.gr "nftban report generate --output /etc/test.html"

# Test 6: Path traversal (should fail)
ssh root@lab.mywebhost.gr "nftban report generate --output ../../etc/passwd"

# Test 7: Check audit log
ssh root@lab.mywebhost.gr "tail -20 /var/log/nftban/security-audit.log"
```
