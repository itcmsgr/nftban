...
echo "  ssh root@lab1.example.test 'nftban fhs'"
```
...
ssh root@lab1.example.test 'ls -ld /usr/lib/nftban'
# Expected: drwxr-xr-x root root

ssh root@lab1.example.test 'ls -ld /var/lib/nftban'
# Expected: drwxr-xr-x nftban nftban

# 3. Verify files are readable/executable
ssh root@lab1.example.test 'nftban module'
