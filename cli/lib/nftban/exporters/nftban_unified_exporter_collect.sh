#!/usr/bin/env bash
# =============================================================================
# NFTBan Unified Metrics Exporter - Collection Module
# =============================================================================
# SPDX-License-Identifier: MPL-2.0
# Purpose: Main metrics collection function (collect_all_metrics)
...
# =============================================================================
# GUI CACHE FILE GENERATION
# =============================================================================
# Generates additional JSON cache files for GUI visualization:
# - traffic_history.json: 24-hour bandwidth history for charts
# - dropped_by_country.json: Blocked IPs by country from geoban logs
# - dropped_by_port.json: Blocked connections by port from portscan logs
# =============================================================================
