...
if [ $1 -eq 1 ]; then
    ...
    echo ""
    echo "  Press ENTER when asked, then type 'y' to enable."
    echo "  Takes 30 seconds. Safe and simple."
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    echo "What you get after setup:"
    echo ""
    echo "  🛡️  Protection from SSH brute force attacks"
    echo "  🛡️  Protection from port scanning"
    echo "  🛡️  Automatic blocking of bad IPs"
    echo "  🛡️  Your SSH port $SSH_PORT is already safe from lockout"
    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
