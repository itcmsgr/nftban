#!/usr/bin/env bash
# =============================================================================
# NFTBan v0.32.25 - Path Validation & Write Security Module
# =============================================================================
...
declare -ga NFTBAN_ALLOWED_WRITE_DIRS=(
    "/var/lib/nftban/reports"      # Application state reports
    "/var/lib/nftban/metrics"      # Statistics metrics database
    "/var/lib/nftban/snapshots"    # Hourly stats snapshots
    "/var/lib/nftban/exports"      # User exports
    "/var/lib/nftban/geoip"        # GeoIP database
    "/var/log/nftban"              # Log files (daemon writes)
    "/var/log/nftban/reports"      # Report files in logs
...
nftban_path_audit_log() {
    local event_type="$1"
    local message="$2"
    local audit_log="/var/log/nftban/security-audit.log"
