...
$ ssh root@server1.example.com 'nft list set inet nftban_runtime temp_ban_v4 | grep -c timeout'
4

$ ssh root@server1.example.com 'nft list set inet nftban_runtime temp_ban_v6 | grep -c timeout'
1

$ ssh root@server1.example.com 'nft list set inet nftban_main whitelist_v4 | grep -oP "\d+\.\d+\.\d+\.\d+" | wc -l'
2

$ ssh root@server1.example.com 'nft list set inet nftban_main whitelist_v6 | grep -c "::"'
1
