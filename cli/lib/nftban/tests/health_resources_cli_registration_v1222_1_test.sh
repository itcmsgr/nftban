...
# meta:inventory.files="cmd/nftban-core/main.go,cmd/nftban-core/cmd_resources.go,cli/lib/nftban/cli/cmd_health.sh,cli/lib/nftban/cli/cmd_profile.sh"
...
# meta:ta.id="health_resources_cli_registration_v1222_1_test"
# meta:ta.owner="cli"
# meta:ta.module="health-resources"
