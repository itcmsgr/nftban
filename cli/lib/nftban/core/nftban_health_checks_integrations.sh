...
# =============================================================================
# NFTBan - Health Check Integrations Functions
# =============================================================================
# SPDX-License-Identifier: MPL-2.0
# Purpose: Integration-related health check functions (metrics, zabbix, connectors, pro, watchdog)
#
...
export -f nftban_health_check_watchdog
