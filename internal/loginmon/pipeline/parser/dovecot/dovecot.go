...
//
//	Apr  9 03:01:45 srv2 dovecot[3767044]: imap-login: Login aborted: Connection closed (auth failed, 1 attempts in 3 secs) (auth_failed): user=<contact@printtec.gr>, method=PLAIN, rip=34.138.135.178, lip=46.224.164.97, TLS, session=<21JEPP5Ozskiioey>
//
