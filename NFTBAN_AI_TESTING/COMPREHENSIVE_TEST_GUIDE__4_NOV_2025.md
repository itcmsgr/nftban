...
**Version:** v0.30.0
**Target Servers:** lab.example.test, lab1.example.test, lab2.example.test, lab3.example.test, lab4.example.test
...
|--------|----------|-----|--------------|--------------|--------|
| **lab** | lab.example.test | CentOS Stream 9 | x86_64 | RPM | ✅ Active |
| **lab1** | lab1.example.test | Ubuntu 24.04 | x86_64 | DEB | ✅ Active |
| **lab2** | lab2.example.test | CentOS Stream 10 | x86_64 | RPM | ✅ Active |
| **lab3** | lab3.example.test | AlmaLinux 10.0 | x86_64 | RPM | ✅ Active |
| **lab4** | lab4.example.test | Rocky Linux 10 | x86_64 | RPM | ✅ Active |
