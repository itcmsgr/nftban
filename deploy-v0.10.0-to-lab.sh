...
if [[ $success_count -eq ${#LAB_SERVERS[@]} ]]; then
    ...
    echo ""
    echo "Next steps:"
    echo "  1. Test banner: ssh root@lab.mywebhost.gr 'bash -c \"source /usr/lib/nftban/core/nftban_output.sh && nftban_render_banner full\"'"
    echo "  2. Verify user: ssh root@lab.mywebhost.gr 'id nftban'"
    echo "  3. Check logs: ssh root@lab.mywebhost.gr 'ls -la /var/log/nftban/'"
else
