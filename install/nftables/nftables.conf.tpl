...
table ip6 nftban {
    ...
    chain input {
        ...
        tcp flags syn ct state new tcp dport @tcp_ports_in meter syn_prefix_meter_v6 { ip6 saddr & ffff:ffff:ffff:ffff:: limit rate over 100/second burst 200 packets } counter name input_syn_prefix_drop counter name total_input_drop drop comment "/64 prefix SYN rate exceeded"
