...
### Lab Server Activity
- **lab.mywebhost.gr:** 21 bans (14 active: 4 SSHD + 10 recidive)
- **lab1.mywebhost.gr:** 22 bans (very active, latest at 22:00)
- **lab2.mywebhost.gr:** 7 bans (quieter)
...
### Check System Health
```bash
ssh root@lab.mywebhost.gr "nftban help"
ssh root@lab.mywebhost.gr "nftban check"
```

### View Stats
```bash
ssh root@lab.mywebhost.gr "nftban stats overall"
...
### Test Commands
```bash
ssh root@lab.mywebhost.gr "nftban port status | head -20"
ssh root@lab.mywebhost.gr "nftban whitelist-system show"
```
