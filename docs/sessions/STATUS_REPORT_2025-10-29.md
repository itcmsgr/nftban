...
- lab.example.test - Connection timeout
- lab1.example.test - Connection timeout
- lab2.example.test - Connection timeout
...
|--------|----------------|----------|----------|
| lab.example.test | ✅ Ready | ⏳ Pending | ⏳ Pending |
| lab1.example.test | ✅ Ready | ⏳ Pending | ⏳ Pending |
| lab2.example.test | ✅ Ready | ⏳ Pending | ⏳ Pending |
...
**Steps:**
1. Test connectivity: `timeout 10 ssh root@lab.example.test "echo OK"`
