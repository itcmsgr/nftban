...
|--------|----|---------| -------|--------|
| **lab.mywebhost.gr** | CentOS Stream 9 | 9 (base) | 5.14.0-542.el9.x86_64 | ✅ WORKING |
| **lab1.mywebhost.gr** | Ubuntu | 24.04 LTS (Noble) | TBD | ✅ WORKING |
| **lab2.mywebhost.gr** | CentOS Stream 10 | 10 (Coughlan) | 6.12.0-116.el10.x86_64 | ✅ WORKING |
