...
**Servers:**
- `lab.mywebhost.gr` - Accessible via root@ (gituser@ failed)
- `lab2.mywebhost.gr` - Accessible via root@
- `lab1.mywebhost.gr` - OFFLINE

**Resolution:** Manual bootstrap deployment

```bash
# Deploy fixed update module
ssh root@lab.mywebhost.gr "curl -fsSL https://raw.githubusercontent.com/itcmsgr/nftban/main/lib/nftban_update_module.sh -o /etc/nftban/lib/nftban_update_module.sh"

# Then use standard update mechanism
ssh root@lab.mywebhost.gr "nftban update"
```
...
**Test:** Update on lab.mywebhost.gr after fix
...
**Test:** Complete enable/disable cycle on lab.mywebhost.gr
