...
readonly NFTBAN_FEEDS_CONFIG="${NFTBAN_CONFIG_DIR}/conf.d/feeds.conf"
readonly NFTBAN_FEEDS_STORAGE_DIR="${NFTBAN_FEEDS_STORAGE_DIR:-${NFTBAN_DATA_DIR}/feeds}"
readonly NFTBAN_FEEDS_CACHE_DIR="${NFTBAN_FEEDS_CACHE_DIR:-${NFTBAN_CACHE_DIR}/feeds}"
readonly NFTBAN_FEEDS_LOG="${NFTBAN_FEEDS_LOG:-${NFTBAN_LOG_DIR}/feeds.log}"
# Use central config for Go binary path (NO HARDCODED FALLBACKS)
readonly NFTBAN_FEEDS_BINARY="${NFTBAN_CORE_BIN:-${NFTBAN_LIB_DIR}/bin/nftban-core}"
readonly NFTBAN_FEEDS_LOCKFILE="${NFTBAN_RUN_DIR}/feeds-update.lock"
