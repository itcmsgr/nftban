...
### Lab Server Status:
- **lab.mywebhost.gr** - CentOS Stream 9, manual v0.10, no email config
- **lab1.mywebhost.gr** - Ubuntu 24.04, manual v0.10, no email config
- **lab2.mywebhost.gr** - CentOS Stream 10, manual v0.10, no email config
- **lab3.mywebhost.gr** - AlmaLinux 10.0, manual v0.10, no mail command
- **lab4.mywebhost.gr** - Rocky Linux 10, RPM v0.10, no mail command
