...
```bash
# Run on lab servers
ssh root@server1.example.com "nftban module"
ssh root@server1.example.com "nftban fhs"
ssh root@server1.example.com "nftban port status"
ssh root@server1.example.com "nftban stats dashboard"
```
