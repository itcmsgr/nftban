...
**Servers:**
- lab.example.test - ⏳ Connectivity timeout
- lab1.example.test - ⏳ Connectivity timeout
- lab2.example.test - ⏳ Connectivity timeout
...
timeout 10 ssh root@lab.example.test "echo OK"
