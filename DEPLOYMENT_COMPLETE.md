...
```bash
# Test on each server
ssh root@lab.mywebhost.gr "nftban stats && nftban report help"
ssh root@lab1.mywebhost.gr "nftban stats && nftban report help"
ssh root@lab2.mywebhost.gr "nftban stats && nftban report help"

# Check cron jobs
ssh root@lab.mywebhost.gr "cat /etc/cron.d/nftban-stats"
