...
declare -A SERVERS=(
    ["lab.example.test"]="CentOS Stream 9:rpm:el9"
    ["lab1.example.test"]="Ubuntu 24.04:deb:amd64"
    ["lab2.example.test"]="CentOS Stream 10:rpm:el9"
    ["lab3.example.test"]="AlmaLinux 10.0:rpm:el10"
    ["lab4.example.test"]="Rocky Linux 10:rpm:el10"
)
