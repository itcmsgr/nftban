...
ssh root@lab.example.test "systemctl status cron || systemctl status crond"

# Check cron file
ssh root@lab.example.test "cat /etc/cron.d/nftban"

# Monitor execution
ssh root@lab.example.test "tail -f /var/log/nftban/cron.log"
```
...
**Date:** 2025-10-29
**Deployed to:** lab.example.test, lab1.example.test, lab2.example.test
...
$ ssh root@lab.example.test "ls -la /etc/cron.d/nftban*"
-rw-r--r--. 1 root root 3899 Oct 29 15:14 /etc/cron.d/nftban

# Cron daemon active
$ ssh root@lab.example.test "systemctl is-active crond"
active
