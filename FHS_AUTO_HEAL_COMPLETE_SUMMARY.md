...
**Current Status:**
- ✅ lab.example.test: 21/21 OK
- ✅ lab1.example.test: 21/21 OK
- ✅ lab2.example.test: 21/21 OK
...
5. **Verify:**
   ```bash
   ssh root@lab1.example.test 'nftban fhs'
   ```
...
[ ] ssh root@lab.example.test 'nftban fhs | tail -1'
[ ] ssh root@lab1.example.test 'nftban fhs | tail -1'
[ ] ssh root@lab2.example.test 'nftban fhs | tail -1'
```
