#!/bin/bash
# =============================================================================
# NFTBan CLI Inventory Export Script
# =============================================================================
# Exports all CLI commands with metadata to various formats
#
# Usage:
#   ./export_cli_inventory.sh [format]
#
# Formats:
...
case "$FORMAT" in
    ...
    json)
        ...
        for cmd_file in "$CLI_DIR"/cmd_*.sh; do
            ...
            ver=$(grep -oP 'meta:version=\K[0-9.]+' "$cmd_file" 2>/dev/null | head -1 || echo "1.0.0")
