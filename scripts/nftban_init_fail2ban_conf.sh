...
bantime = NFTBAN_F2B_jail_name_BAN_TIME:-NFTBAN_F2B_DEF_BAN_TIME}
maxretry = NFTBAN_F2B_jail_name_MAX_RETRY:-NFTBAN_F2B_DEF_MAX_RETRY}
findtime = NFTBAN_F2B_jail_name_FIND_TIME:-NFTBAN_F2B_DEF_FIND_TIME}
