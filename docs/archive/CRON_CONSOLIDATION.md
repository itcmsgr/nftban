...
ssh root@server1.example.com "systemctl status cron || systemctl status crond"

# Check cron file
ssh root@server1.example.com "cat /etc/cron.d/nftban"
...
**Date:** 2025-10-29
**Deployed to:** server1.example.com, server2.example.com, server3.example.com
...
$ ssh root@server1.example.com "ls -la /etc/cron.d/nftban*"
-rw-r--r--. 1 root root 3899 Oct 29 15:14 /etc/cron.d/nftban

# Cron daemon active
$ ssh root@server1.example.com "systemctl is-active crond"
active
