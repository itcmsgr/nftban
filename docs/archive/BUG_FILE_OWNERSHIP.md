...
echo "  ssh root@server2.example.com 'nftban fhs'"
```
...
ssh root@server2.example.com 'ls -ld /usr/lib/nftban'
# Expected: drwxr-xr-x root root

ssh root@server2.example.com 'ls -ld /var/lib/nftban'
# Expected: drwxr-xr-x nftban nftban

# 3. Verify files are readable/executable
ssh root@server2.example.com 'nftban module'
