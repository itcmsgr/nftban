...
|--------|-----------|--------|
| lab.example.test | 19,403 bytes | ⚠️ OLD VERSION |
| lab1.example.test | 19,403 bytes | ⚠️ OLD VERSION |
| lab2.example.test | Unknown | ⚠️ CONNECTIVITY TIMEOUT |
...
|--------|--------|--------|
| lab.example.test | ⏳ Pending | Connectivity timeout |
| lab1.example.test | ⏳ Pending | Connectivity timeout |
| lab2.example.test | ⏳ Pending | Connectivity timeout |
...
3. **Verify Production** (20 minutes)
   ...
   ssh root@lab.example.test "nftban firewall check"
   ssh root@lab1.example.test "nftban firewall check"
   ssh root@lab2.example.test "nftban firewall check"
   ```
...
```
ssh: connect to host lab.example.test port 22: Connection timed out
ssh: connect to host lab1.example.test port 22: Connection timed out
ssh: connect to host lab2.example.test port 22: Connection timed out
```

**Current Server State:**
- lab.example.test: Has OLD cmd_firewall.sh (19,403 bytes)
- lab1.example.test: Has OLD cmd_firewall.sh (19,403 bytes)
- lab2.example.test: Unknown (cannot connect)
...
- Test with: `timeout 5 ssh root@lab.example.test "echo OK"`
