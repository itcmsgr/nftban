...
# Version: 3.4.0 (Enhanced with auto-sync, CIDR support, export/import, log management)
...
show_help() {
  cat << 'EOF'
NFTBan – nftables & Fail2Ban helper (v3.4.0)
===========================================
...
NEW IN v3.4.0
-------------
--export-set <SET> <FILE>    Export a set definition
--import-set <FILE>          Import a set definition
--view-log                   Show nftban log
--clear-log                  Truncate nftban log
EOF
}
...
read -p "Θέλεις να συγχρονίσεις τις αλλαγές με το nftables τώρα; (y/N): " sync_reply
