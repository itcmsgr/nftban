...
| **nftban_init_nftables_conf.sh** | Firewall configuration | Rule generation, validation, application |
...
User runs: nftban --sync
   OR
User runs: nftban_init_nftables_conf.sh --install-final
        │
        ▼
┌──────────────────────────────────────────────┐
...
│   ├── nftban_init.sh                   # System preparation
│   ├── nftban_init_nftables_conf.sh     # Firewall configuration
│   ├── nftban_init_fail2ban_conf.sh     # Intrusion prevention
│   └── nftban_auto_update.sh            # Auto-update (if enabled)
│
...
```
┌────────────────────────────────────────────────────┐
│  User runs: nftban_init_nftables_conf.sh          │
│             --install-final                        │
└─────────────┬──────────────────────────────────────┘
              │
              ▼
...
```nft
#!/usr/sbin/nft -f
# Generated by nftban_init_nftables_conf.sh
