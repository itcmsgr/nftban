...
### For lab.example.test and lab2.example.test (LOCKED OUT)
...
|--------|----------|--------|
| lab.example.test | ❌ | LOCKED OUT - needs console |
| lab1.example.test | ⏳ | Ready to deploy |
| lab2.example.test | ❌ | LOCKED OUT - needs console |
