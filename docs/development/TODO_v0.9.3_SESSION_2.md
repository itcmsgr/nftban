...
- [x] Deployed to CentOS 9 (lab.mywebhost.gr)
- [x] Deployed to Ubuntu 24 (lab1.mywebhost.gr)
- [x] Deployed to CentOS 10 (lab2.mywebhost.gr)
...
```bash
# Test on each server
ssh root@lab.mywebhost.gr "cd /etc/nftban && source lib/nftban_core.sh && source lib/<module>.sh && <test_command>"
```
