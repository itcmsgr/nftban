...
```bash
# Test on each server
ssh root@lab.example.test "nftban stats && nftban report help"
ssh root@lab1.example.test "nftban stats && nftban report help"
ssh root@lab2.example.test "nftban stats && nftban report help"

# Check cron jobs
ssh root@lab.example.test "cat /etc/cron.d/nftban-stats"
