...
echo "  2. Test tomorrow: ssh wronguser@lab.mywebhost.gr (fail 5 times)"
echo "  3. Check logs: ssh root@lab.mywebhost.gr 'tail /var/log/nftban/fail2ban-bans.log'"
echo "  4. View stats: ssh root@lab.mywebhost.gr '/usr/sbin/nftban-complete stats'"
echo ""
