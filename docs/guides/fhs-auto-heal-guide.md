...
**Current Status:**
- ✅ server1.example.com: 21/21 OK
- ✅ server2.example.com: 21/21 OK
- ✅ server3.example.com: 21/21 OK
...
[ ] ssh root@server1.example.com 'nftban fhs | tail -1'
[ ] ssh root@server2.example.com 'nftban fhs | tail -1'
[ ] ssh root@server3.example.com 'nftban fhs | tail -1'
```
