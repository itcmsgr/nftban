...
|--------|------------|--------|-------------|
| lab.mywebhost.gr | CentOS Stream 9 | ✅ SUCCESS | Inventory: Valid JSON |
| lab1.mywebhost.gr | Ubuntu 24.04 | ✅ SUCCESS | Inventory: Valid JSON |
| lab2.mywebhost.gr | CentOS Stream 10 | ✅ SUCCESS | Inventory: Valid JSON |
| lab3.mywebhost.gr | AlmaLinux 10.0 | ✅ SUCCESS | Inventory: Valid JSON |
| lab4.mywebhost.gr | Rocky Linux 10 | ✅ SUCCESS | Inventory: Valid JSON |
...
```bash
# Test on any server
ssh root@lab.mywebhost.gr "nftban-health --inventory | jq '.processes | length'"
ssh root@lab1.mywebhost.gr "nftban-health --inventory | jq '.os.kernel'"
ssh root@lab2.mywebhost.gr "which nftban-health"
ssh root@lab3.mywebhost.gr "ls -lh /usr/libexec/nftban/"
ssh root@lab4.mywebhost.gr "nftban-health --inventory | jq '.firewall'"
```
