...
# meta:inventory.files="packaging/build_nftban.sh,packaging/deb/postrm,packaging/deb/conffiles"
...
# meta:ta.id="health_resource_dropin_packaging_guard_v1222_1_test"
