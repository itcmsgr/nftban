...
### For lab.mywebhost.gr and lab2.mywebhost.gr (LOCKED OUT)
...
|--------|----------|--------|
| lab.mywebhost.gr | ❌ | LOCKED OUT - needs console |
| lab1.mywebhost.gr | ⏳ | Ready to deploy |
| lab2.mywebhost.gr | ❌ | LOCKED OUT - needs console |
