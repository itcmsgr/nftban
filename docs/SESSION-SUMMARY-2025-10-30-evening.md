...
**System:** lab4.example.test (Rocky Linux 10.0)
...
| Server | Status | Notes |
|--------|--------|-------|
| lab.example.test | ⏸️  PENDING | Wait for lab4 stability |
| lab1.example.test | ⏸️  PENDING | Wait for lab4 stability |
| lab2.example.test | ⏸️  PENDING | Wait for lab4 stability |
